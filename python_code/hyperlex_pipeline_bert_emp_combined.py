...
from utility import import_hyperlex, cosine_similarity, calculate_kl_bert, bert_cosine_similarity
...
def main():
    ...
    if use_curated_data:
        ...
        with open(f'../data_shared/hyperlex_output/curated/hyp_curated{max_context}_random.pickle', 'rb') as f:
